...
* Study the code in the source file `main.cpp`. Again we have commented the code, so that you should understand it. Information on the used OpenCV API can be found [here](https://docs.opencv.org/3.4/index.html). Here are some further hints for understanding the code:
