...
# Convert usb cam video stream to gray scale, do the convolution and stream
# video over RTP H264 encoded to laptop
# Note: Make sure correct HW platform is loaded (VCU, multi_scaler and convolution IPs)
...
json_loc="/home/ubuntu/projects/convolution/vvas_libs_kria/hardkernel/hardkernel.json"
